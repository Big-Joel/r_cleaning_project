#Code Book for the file tidyDataSet.txt

The values given are the average (mean) of all the values that were recorded for each subject while performing each activity.
